...
public class SpanHelperGeneric_UInt32_BinaryOperations_SingleCount
{
    ...
    private static CustomRange<uint>[] Generate(int size, InputType input, Random random)
    {
    ...
    {
        Random random = new();
        this.rangesArray_1 = Generate(SetSize, Input, random);
        this.rangesArray_2 = Generate(SetSize, Input, random);
    }
